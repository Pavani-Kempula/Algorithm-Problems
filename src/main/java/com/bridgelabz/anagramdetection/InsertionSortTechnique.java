...
public class InsertionSortTechnique {
    /*accepting generic type of data using comapreTo() to compare and arrange the output in alphabetic order
    ...
    public static void main(String[] args) {
        String[] inputArray = {"Hello","Pavani","Good","Night","Keep","Calm"};
        System.out.println(Arrays.toString(inputArray));
