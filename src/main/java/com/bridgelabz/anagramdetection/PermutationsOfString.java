...
public class PermutationsOfString {
    ...
    public static void recursion(String question, String answer)
    {
        ...
        for(int i = 0; i < question.length(); i++) {
            ...
            recursion(restOfTheQuestion, answer + ch); // calling method recursively.
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Recursion output : \t");
